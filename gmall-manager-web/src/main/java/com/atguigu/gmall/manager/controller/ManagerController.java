...
public class ManagerController {
    ...
    public List<BaseCatalog1> getCatalog1(){
        List<BaseCatalog1> catalog1List = managerService.getCatalog1();
        return catalog1List;
    }
    ...
    public List<BaseCatalog2> getCatalog2(@RequestParam Map<String,String> map){
        ...
        List<BaseCatalog2> catalog2List = managerService.getCatalog2(catalog1Id);
        return catalog2List;
    }
    ...
    public List<BaseCatalog3> getCatalog3(@RequestParam Map<String,String> map){
        ...
        List<BaseCatalog3> catalog3List = managerService.getCatalog3(catalog2Id);
        return catalog3List;
    }
